...
def move_images_without_xml(directory):
    ...
    for image_file in image_files:
        # Get the corresponding XML file name
        xml_file = os.path.splitext(image_file)[0] + '.xml'
        
        # If the XML file does not exist, move the image file
...
move_images_without_xml(directory)
